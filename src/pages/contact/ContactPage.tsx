...
const ContactPage = () => {
    ...
    return (
        <div className="bg-gray-50 min-h-screen">
            ...
            {/* Hero Section */}
            <header className="relative bg-[url('./src/assets/contactbg.jpg')] bg-cover bg-center w-full">
                ...
                <div className="relative max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="mt-6 max-w-2xl mx-auto text-xl text-indigo-100">We're here to help you with any questions or concerns you may have</p>
                </div>
            </header>
            ...
            <section className="py-16 px-4 max-w-7xl mx-auto">
                <div className='relative mb-12'>
                    <h2 className="text-4xl font-bold text-center text-indigo-900 mb-4">Get In Touch</h2>
                    <div className="block absolute left-1/2 transform -translate-x-1/2 h-1 w-20 bg-[#d62828] rounded-2xl"></div>
                </div>
                <p className="text-lg text-gray-700 text-center max-w-3xl mx-auto mb-12">
                We welcome your inquiries, feedback, and suggestions. Please don't hesitate to reach out to us using any of the methods below.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-md">
                        ...
                        <div className="flex mb-6">
                            <div className="text-2xl text-indigo-900 mr-4"><LocationOnIcon/></div>
                            <div>
                        ...
                        <div className="flex mb-6">
                            <div className="text-2xl text-indigo-900 mr-4"><CallIcon/></div>
                            <div>
                                <h4 className="font-bold text-indigo-900 mb-2">Phone</h4>
                                <p className="text-gray-700">
                                    Main: (555) 123-4567<br />
                                    Reference Desk: (555) 123-4568<br />
                        ...
                        <div className="flex mb-6">
                            <div className="text-2xl text-indigo-900 mr-4"><EmailIcon/></div>
                            <div>
                                <h4 className="font-bold text-indigo-900 mb-2">Email</h4>
                                <p className="text-gray-700">
                                    info@libraryhub.org<br />
                                    reference@libraryhub.org<br />
            ...
            <section className="py-16 px-4 bg-white">
                <div className="max-w-5xl mx-auto">
                    <div className='relative mb-12'>
                        <h2 className="text-4xl font-bold text-center text-indigo-900 mb-4">Library Hours</h2>
                        <div className="block absolute left-1/2 transform -translate-x-1/2 h-1 w-20 bg-[#d62828] rounded-2xl"></div>
                    </div>
                    ...
                    <div className="overflow-x-auto">
                        ...
                        <thead>
                            ...
                            <th className="py-4 px-6 text-left text-indigo-900 font-semibold">Day</th>
                            <th className="py-4 px-6 text-left text-indigo-900 font-semibold">Hours</th>
                            <th className="py-4 px-6 text-left text-indigo-900 font-semibold">Special Notes</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-200">
                            ...
                            { day: 'Wednesday', hours: '9:00 AM - 8:00 PM', notes: 'Story Time at 10:30 AM' },
                            { day: 'Thursday', hours: '9:00 AM - 8:00 PM', notes: '' },
                            { day: 'Friday', hours: '9:00 AM - 6:00 PM', notes: '' },
                            { day: 'Saturday', hours: '10:00 AM - 5:00 PM', notes: 'Book Club at 2:00 PM' },
                            { day: 'Sunday', hours: '1:00 PM - 5:00 PM', notes: 'Limited services' }
                            ].map((day, index) => (
                            <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                                <td className="py-4 px-6 text-gray-800 font-medium">{day.day}</td>
                    ...
                    <div className="mt-8 text-center text-gray-700">
                        ...
                        <p>The library is closed on all Federal holidays. Special hours may apply during holiday seasons.</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 px-4 max-w-7xl mx-auto">
                <div className='relative mb-12'>
                    <h2 className="text-4xl font-bold text-center text-indigo-900 mb-4">Find Us</h2>
                    <div className="block absolute left-1/2 transform -translate-x-1/2 h-1 w-20 bg-[#d62828] rounded-2xl"></div>
                </div>
                ...
                <div className="mt-8 text-center text-gray-700">
                    ...
                    <p>We are also accessible via public transit - Bus routes 12, 15, and 18 stop directly in front of our building.</p>
                </div>
            </section>
            ...
            <section className="py-16 px-4 bg-gray-50">
                <div className="max-w-4xl mx-auto">
                    <div className='relative mb-12'>
                        <h2 className="text-4xl font-bold text-center text-indigo-900 mb-4">Frequently Asked Questions</h2>
                        <div className="block absolute left-1/2 transform -translate-x-1/2 h-1 w-20 bg-[#d62828] rounded-2xl"></div>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        { 
                            ...
                            answer: 'Library cards are available free of charge to all residents. Simply visit the library with a photo ID and proof of address (utility bill, lease agreement, etc.). Children under 16 must be accompanied by a parent or guardian.' 
                        },
                        { 
                            question: 'What is the loan period for materials?', 
                            answer: 'Most books can be borrowed for 3 weeks. DVDs and high-demand items have a 1-week loan period. Reference materials must be used within the library.'
                        },
                        { 
                            question: 'How can I renew my borrowed items?', 
                            answer: 'Items can be renewed online through your account, by phone, or in person at the circulation desk. Materials can be renewed twice if there are no holds on the item.'
                        },
                        { 
                            question: 'Do you offer interlibrary loans?', 
                            answer: 'Yes, we participate in the regional interlibrary loan system. If we don\'t have a particular item, we can often borrow it from another library. Please ask at the reference desk for assistance.'
                        }
                        ].map((faq, index) => (
                        <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden">
                            <div className="p-6">
                            <h3 className="font-bold text-lg text-indigo-900 mb-2">{faq.question}</h3>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-gray-700 mb-4">Have more questions? Feel free to contact us!</p>
                        <a href="#" className="inline-block bg-indigo-900 hover:bg-indigo-800 text-white font-medium py-2 px-6 rounded-md transition-colors">
                        Ask a Librarian
                        </a>
                    </div>
                </div>
            ...
            <footer className="bg-indigo-900 text-white py-8 px-4">
                ...
                <p>Chabahill, Kathmandu | Phone: (+977) 123-4567</p>
                </div>
            </footer>
        </div>
    );
